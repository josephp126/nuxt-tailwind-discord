...
<div class="relative">
        <header class="absolute top-7 lg:top-14  w-full py-3 lg:py-0 z-20">
            <div class="container grid grid-cols-2 lg:grid-cols-3  lg:justify-items-center  items-center ">
                ...
                <div class=" justify-self-start lg:justify-self-center ">
                    <nuxt-link to="#" class="img-fluid" >
                        <img src="/svg/brand-logo.svg" alt="">
                    </nuxt-link>
                </div>
                <!-- toggle menu -->
                <div class="  flex lg:hidden justify-end w-full ">
                    <div :class="`toggle ${isActive ? 'active' : ''} `" @click="openSidebar" >
                        <span></span>
                        <span></span>
                        <span></span>
                    </div>
        ...
        <div v-if="sideBar" :class="` max-w-full md:max-w-3xl mx-auto absolute left-0 md:left-1/2 transform md:-translate-x-1/2  top-full w-full bg-black24 shadow lg:hidden z-10 ` ">
